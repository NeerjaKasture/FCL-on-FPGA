...
HD_PWD='C:/Users/anura/Downloads/project_bram_new/project_bram/project_bram/project_bram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_.tcl -notrace
