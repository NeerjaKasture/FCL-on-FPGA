...
HD_PWD='C:/Users/anura/Downloads/project_bram_new/project_bram/project_bram/project_bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_.tcl
