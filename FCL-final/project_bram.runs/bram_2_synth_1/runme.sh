...
HD_PWD='C:/Users/anura/Downloads/project_bram_new/project_bram/project_bram/project_bram.runs/bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_2.tcl
